...
CAMPAIGN_SLUG = "dia-imbativel-16-01"
CAMPAIGN_BASE_PATH = (
    r"G:\Drives compartilhados\__JOBS 2025\_ASSAI\_ROBO ASSAI\MIDIAS\DIA IMBATIVEL 16.01"
)
...
CAMPAIGNS = [
    {
        "period": "HOJE",
        "region": "NACIONAL",
        "option_sheet": "diaImbativel1601Hoje",
        "display": "Dia Imbativel 16.01 Hoje Nacional",
    },
    {
        "period": "HOJE",
        "region": "MG",
        "option_sheet": "diaImbativel1601HojeMg",
        "display": "Dia Imbativel 16.01 Hoje Mg",
    },
    {
        "period": "AMANHA",
        "region": "NACIONAL",
        "option_sheet": "diaImbativel1601Amanha",
        "display": "Dia Imbativel 16.01 Amanha Nacional",
    },
    {
        "period": "AMANHA",
        "region": "MG",
        "option_sheet": "diaImbativel1601AmanhaMg",
        "display": "Dia Imbativel 16.01 Amanha Mg",
    },
    {
        "period": "GENERICO",
        "region": "NACIONAL",
        "option_sheet": "diaImbativel1601Generico",
        "display": "Dia Imbativel 16.01 Generico Nacional",
    },
    {
        "period": "GENERICO",
        "region": "MG",
        "option_sheet": "diaImbativel1601GenericoMg",
        "display": "Dia Imbativel 16.01 Generico Mg",
    },
]
...
def generate_cabecas_csv(current_date: str, cabeca_root: str) -> int:
    ...
    for campaign in CAMPAIGNS:
        ...
        if not period_path:
            continue
        region_dirs = map_region_dirs(period_path)
...
def generate_assinaturas_csv(current_date: str, assinatura_root: str) -> int:
    print("Gerando CSV de assinaturas...")
    rows = []
    period_dirs = map_period_dirs(assinatura_root)
...
def main() -> None:
    ...
    total_assinaturas = generate_assinaturas_csv(current_date, assinatura_root or "")
