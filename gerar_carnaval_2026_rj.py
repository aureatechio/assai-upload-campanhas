...
CAMPAIGN_SLUG = "carnaval-2026-rj"
CAMPAIGN_BASE_PATH = (
    r"G:\Drives compartilhados\__JOBS 2025\_ASSAI\_ROBO ASSAI\MIDIAS\CARNAVAL 2026 -RJ"
)
...
CAMPAIGN = {
    "display": "Carnaval 2026 Rj",
    "option_sheet": "carnaval2026Rj",
}
...
def main() -> None:
    ...
    print("=" * 60)
    print("GERADOR DE CSVs - CARNAVAL 2026 RJ")
    print("=" * 60)
