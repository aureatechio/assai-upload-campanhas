...
CAMPAIGN_SLUG = "inauguracao-araguaina"
CAMPAIGN_BASE_PATH = (
    r"G:\Drives compartilhados\__JOBS 2025\_ASSAI\_ROBO ASSAI\MIDIAS\INAUGURACAO ARAGUAINA"
)
...
CAMPAIGNS = [
    {
        "region": "NACIONAL",
        "display": "Inauguracao Araguaina Nacional",
        "option_sheet": "inauguracaoAraguainaNacional",
    },
    {
        "region": "MG",
        "display": "Inauguracao Araguaina Mg",
        "option_sheet": "inauguracaoAraguainaMg",
    },
]
...
def find_region_folder(parent: str, region: str) -> Optional[str]:
    """Tenta localizar o subdiretório que representa a região (aceita nomes com sufixos)."""
...
def generate_cabecas_csv(current_date: str) -> int:
    ...
    files = scan_media_files(cabeca_root)
...
def generate_assinaturas_csv(current_date: str) -> int:
    ...
    files = scan_media_files(assinatura_root)
...
def main() -> None:
    ...
    print("=" * 60)
    print("GERADOR DE CSVs - INAUGURACAO ARAGUAINA")
    print("=" * 60)
